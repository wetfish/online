...
function Display()
{
	...
	$context['page_title'] = $topicinfo['subject'] . ' - ' . $txt['website_title'];
	...
	// Justin nov 26, 2016 - whatever lets just override the permissions if they are banned from the topic
	$isBannedFromTopic = isBannedFromTopic($topic);
	if ($isBannedFromTopic)
	{
