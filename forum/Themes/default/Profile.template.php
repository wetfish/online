...
// Callback function for editing fish avatar
function template_profile_fish_equipper()
{
	...
	echo'<script type="text/javascript">$displayedInventory = \'', json_encode($context['member']['inventory']) ,'\';</script>';
...
function displayEquipmentIconButton($item)
{
	global $txt, $context, $boardurl;
