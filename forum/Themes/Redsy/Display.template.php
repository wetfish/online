...
function template_main()
{
	...
	// include inventory helpers
	echo '<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/inventory.js"></script>';
	...
	echo '
			<div class="pagesection">
				...
				<div class="pagelinks floatleft">', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#lastPost"><strong>' . $txt['go_down'] . '</strong></a>' : '', '</div>
			</div>';
	...
	while ($message = $context['get_message']())
	{
		...
		// load the fish avatars
		echo  '<script type="text/javascript">
					$(document).ready(function() {
					   loadAvatar(\'',json_encode($message['inventory']),'\', "fishcanvas_',  $message['id'], '", "fish_avatar_img_',  $message['id'],'");
					});
			   </script>';
...
*/
		...
		echo '
				...
				if ($message['can_approve'] || $context['can_reply'] || $message['can_modify'] || $message['can_remove'] || $context['can_split'] || $context['can_restore_msg'] ||
					...
					// Can the user ban this poster from the thread?
					if ($message['can_ban_from_topic'])
						echo '
				...
				if(isset($message['topic_ban_reason']))
				{
						echo '<p class="post-ban-reason">', 
								...
								'<br>', $txt['ban_from_topic_reason'], ': ', $message['topic_ban_reason'], 
							'</p>';
